        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumPurchase = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WithdrawnAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AffiliateWithdrawals", x => x.WithdrawalId);
                    table.ForeignKey(
                        name: "FK_AffiliateWithdrawals_Affiliates_AffiliateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAtAddition = table.Column<decimal>(type: "decimal(10,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantImageUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    IsDefault = table.Column<bool>(type: "bit", nullable: false),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AffiliateCommissions", x => x.CommissionId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AffiliateCommissions_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "OrderItemId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AffiliateCommissions_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AffiliateCommissions_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AffiliateCommissions_Sellers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "Sellers",
                        principalColumn: "SellerId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AffiliateCommissions_SubOrders_SubOrderId",
                        column: x => x.SubOrderId,
                        principalTable: "SubOrders",
                        principalColumn: "SubOrderId",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AffiliateCommissions_OrderId",
                table: "AffiliateCommissions",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_AffiliateCommissions_OrderItemId",
                table: "AffiliateCommissions",
                column: "OrderItemId");

            migrationBuilder.CreateIndex(
                name: "IX_AffiliateCommissions_ProductId",
                table: "AffiliateCommissions",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_AffiliateCommissions_SellerId",
                table: "AffiliateCommissions",
                column: "SellerId");

            migrationBuilder.CreateIndex(
                name: "IX_AffiliateCommissions_SubOrderId",
                table: "AffiliateCommissions",
                column: "SubOrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AffiliateWithdrawals_AffiliateId",
                table: "AffiliateWithdrawals",
                column: "AffiliateId");
